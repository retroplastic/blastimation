...
class Rom:
    ...
    def test(self):
        self.save_png("00DB08", 1, 32, 32)
        self.save_png("26A1C0", 1, 40, 40)
        self.save_png("27DB30", 2, 32, 32)
        self.save_png("08EBE8", 3, 64, 64)
        self.save_png_lut("1F0BD8", 4, 64, 32, "047480")
        self.save_png_lut("1DC880", 5, 32, 32, "152970")
        self.save_png("33D7D8", 6, 16, 32)
